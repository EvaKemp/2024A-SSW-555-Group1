...
def BuildTableHeaders():
    ...
    g_FamiliesTable.field_names = ["ID", "Married", "Divorced", "Husband ID", "Husband Name", "Wife ID", "Wife Name",
                                   "Children"]
...
def ParseIndividuals(inLine):
    ...
    if tagList[0].isdigit():
        ...
        dictUser = {"ID": "", "Name": "", "Gender": "", "Birthday": "", "Age": "", "Alive": "", "Death": "",
                    "Child": "", "Spouse": ""}
